...
class Review:
    ...
    def year(self, year):
        if isinstance(year, int) and year > 1999:
            ...
            raise TypeError('year must be an int from 2000')
    @property
    def summary(self):
    ...
    def summary(self,summary):
        if isinstance(summary, str) and not len(summary) == 0:
    ...
    def employee_id(self, employee_id):
        if type(employee_id) is int and Employee.find_by_id(employee_id):
            ...
            raise ValueError("employee_id must be in employees table")
